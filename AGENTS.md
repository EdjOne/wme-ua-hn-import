...
- **v1.8.74**: Додано пакетне створення RPP — Shift+клік по маркеру джерела створює RPP для всіх видимих маркерів цього джерела (Waze/Visicom/OSM)
