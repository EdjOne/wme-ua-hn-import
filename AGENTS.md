...
- **v1.8.66**: RPP строго між проекцією на дорогу та маркером (не перелітає)
- **v1.8.67**: Смещение RPP по нормалі до дороги (перпендикулярно, без бічного зсуву)
- **v1.8.68**: Перпендикуляр через проекцію вектора маркера на дотичну дороги
- **v1.8.69**: Розрахунок перпендикуляра в метрах з урахуванням широти (Одеса 46°)
