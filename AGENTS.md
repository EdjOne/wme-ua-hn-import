...
- **v1.10.0**: `useMarkerStreet` блок тепер перевіряє чи знайдена вулиця є альтернативою — якщо так, використовує primary (Малинова → Івана Дзюби). Радіус пошуку вулиці збільшено до 500м.