...
- **v1.8.90-1.8.96**: Проміжні виправлення (fuzzy matching, distance filter, чищення)
- **v1.8.97**: Snap-to-road — фільтр сегментів за streetId (не чіпляє чужі вулиці)
- **v1.8.100**: POI+RPP: блокировка рівня 2 на обидва (POI + RPP); фокус залишається на POI
