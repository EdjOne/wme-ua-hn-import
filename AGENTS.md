...
- **v1.9.9**: Фікс: `minDistanceToSegment` рахує перпендикулярну відстань до лінії сегмента (через `projectOnSegment`), а не тільки до вузлів. Раніше для довгих сегментів альтернатива не знаходилась, хоча маркер був біля вулиці.