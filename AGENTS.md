...
- **v1.8.76**: Batch RPP за новою логікою: звичайний клік запам'ятовує джерело+вулицю, Shift+клік створює RPP для всіх необроблених маркерів цього джерела на цій вулиці. Не потребує виділення сегмента.
