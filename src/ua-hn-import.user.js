      ...
      tabPane.innerHTML = `
        <div id="qhnua-pane" style="padding:10px;">
          ...
          <div style="margin-top:12px;padding-top:6px;border-top:1px solid #eee;width:100%;box-sizing:border-box;">
            <div style="background:#005bbb;color:#fff;padding:8px;font-size:20px;font-weight:bold;text-align:center;width:100%;box-sizing:border-box;">made in</div>
            <div style="background:#ffd500;color:#000;padding:8px;font-size:20px;font-weight:bold;text-align:center;width:100%;box-sizing:border-box;">Ukraine</div>
          </div>
        </div>
      `;
