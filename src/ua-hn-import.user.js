    ...
    wmeSDK.Sidebar.registerScriptTab().then(({ tabLabel, tabPane }) => {
      ...
      tabPane.innerHTML = `
        <div id="qhnua-pane" style="padding:10px;">
          <h2 style="margin-top:0;font-size:14px;">Швидкий імпорт <span style="color:#8A2BE2;font-weight:bold;margin-left:4px;">▲</span> <span style="font-size:10px;color:#888;font-weight:normal;">v${GM_info.script.version}</span></h2>
